...
const $tarjetaTBody = document.querySelector("#tarjeta")
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (localStorage.getItem("INFORMES") === null) {
        ...
        let cadenaHtmlFinal = cadenaInicial + cadenaTarjetaHtml+ cadenaFinal
...
function creaTarjeta (informe, infoJson){
    ...
    let valorDistrito = datos[10]
    let valorSeccion = datos[11]
    let valorTipoEleccion = datos[12]
    let valorSvg = datos[13]
    let valorCantidadElectores = datos[14]
    let valorMesasTotalizadas = datos[15]
    let valorParticipacionPorcentaje = datos[16]

    let tdMapa = `<td> ${valorSvg} </td>`
    let tdTitulSub = ` <td> <p class="texto-elecciones-chico">Elecciones<br/> ${anio} |<br/> ${valorTipoEleccion}</p>
    <p class="texto-path-chico">${anio} ><br/>${valorTipoEleccion} ><br/>${valorCargo} ><br/> ${valorSeccion} ><br/>${valorDistrito}</p>
    </td>`
    let tdBotoneColores = `    <td>
    <div class="paso-gen">
        <div class="mesa-comp">
            <a href="paso.html">
                <p><span><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            style="font-size: 40px; height: 40px; width: 70px;">
                            <g>
...
M382.635,358.347c23.575,0,43.614,24.754,47.15,57.76h-94.302C339.02,383.101,359.059,358.347,382.635,358.347z">
                        ...
                        </svg>Mesas<br/>Estructuadas<br/>${valorMesasTotalizadas}%</span></p></a>
        </div>
        <div class="electores">
    ...
    c-0.238-0.571-0.797-0.944-1.416-0.944l0,0c-4.601,1.534-7.55-4.364-8.966-9.319c-2.595-10.027-1.18-14.864,0.473-17.105H180.521z">
                ...
                </svg>Electorales<br/>${valorCantidadElectores}%</span></p></a>
...
C184.178,409.323,186.501,406.999,189.368,406.999z"></path>
                        <rect x="195.975" y="387.534" fill="#FFFFFF" width="69.013"
                            height="14.393"></rect>
                    </svg>Participación<br/>sobre<br/>escrutado<br/>${valorParticipacionPorcentaje}%</span></p>
        </div>
    </div>
</td>`
    ...
    return tdMapa + tdTitulSub + tdBotoneColores + tdparteFinal
...
//!!titulo Subtitulo
    // <td>
    //     <p class="texto-elecciones-chico">Elecciones<br/> ${anio} |<br/> ${valoTioEleccion}</p>
    //     <p class="texto-path-chico">${AÑO!!!!!} ><br/>${FUNCION PASO O GENERLAES } ><br/>${CARGO!!!} ><br/> ${SECCION!!!} ><br/>${DISTRITO!!!}</p>
    // </td>
...
//!!Botones de colores
    ...
    //                                 </path>
    //                             </g>
    //                         </svg>Mesas<br/>Estructuadas<br/>${mesasTotalizadas!!!!!!!!!}1%</span></p></a>
    //         </div>
    //         <div class="electores">
    //             <a href="generales.html">
    //                 <p><span><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
    ...
    //     c-0.238-0.571-0.797-0.944-1.416-0.944l0,0c-4.601,1.534-7.55-4.364-8.966-9.319c-2.595-10.027-1.18-14.864,0.473-17.105H180.521z">
    //                     </path>
    //                 </svg>Electorales<br/>${cantidadElectores!!!!!!!!!!!!!}%</span></p></a>
    ...
    //                         <rect x="195.975" y="387.534" fill="#FFFFFF" width="69.013"
    //                             height="14.393"></rect>
    //                     </svg>Participación<br/>sobre<br/>escrutado<br/>${participacionPorcentaje!!!!!!!!}%</span></p>
    //         </div>
    //     </div>
    // </td>
...
//!! parte final
    ...
    //     <div class="oredenar-table">
    //         <div class="tabla-agrupacion">
    //             <p >${filtradoJSON.nombreAgrupacion!!!!!!!!!!!!1}</p>
    //             <p class="tabla-por">%{filtradoJSON.votosPorcentaje!!!!!!!!!!}%<br/>${filtradoJSON.votos!!!!!!!!!!} votos</p>
    //         </div>
    //     </div>
